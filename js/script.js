...
const SUBJECTS = [
  ...
  { id:'Animals and Birds', label:'Animals', icon:'🦁' },
  { id:'Geography',    label:'Geography',    icon:'🌍' },
  { id:'Computer',     label:'Computer',     icon:'💻' },
  { id:'Economics',    label:'Economics',    icon:'📈' },
  { id:'Environmental Studies', label:'EVS', icon:'🌱' },
...
const ACHIEVEMENTS = [
  ...
  { id:'allsubj',    icon:'📚', name:'All-Rounder',         desc:'Play all 11 subjects',                req: g => g.subjectsPlayed && g.subjectsPlayed.length >= 11 },
];
